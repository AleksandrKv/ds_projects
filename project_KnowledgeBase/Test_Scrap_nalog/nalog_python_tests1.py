...
# https://leftjoin.ru/all/nalog-ru-client/   - страница, а в ней ссылка на исходники на GetHab6
...
class NalogRuPython:
    ...
    def _get_ticket_id(self, qr: str) -> str:
        ...
        """
        url = f'https://{self.HOST}/v2/tickets'
        payload = {'qr': qr}
        headers = {
            'Host': self.HOST,
            'Accept': self.ACCEPT,
    ...
    def get_tickets(self) -> str:
        ...
        resp = requests.post(url, json=payload, headers=headers)
        print(resp.json().dumps(ticket, indent=4, ensure_ascii=False))
...
if __name__ == '__main__':
    ...
    # print(json.dumps(tickets, indent=4, ensure_ascii=False))
